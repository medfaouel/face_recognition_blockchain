...
trackImageBtn = tk.Button(window, command=trackImage, background="light sea green", fg="white", text="TRACK IMAGE",
                          width=12,
                          activebackground="red", height=3, font=('Helvetica', 12))
trackImageBtn.place(x=420, y=360)
bruhButton = tk.Button(window, command=ListToBlockchain, background="light sea green", fg="white", text="PRESENCE LIST",
                       width=16,
                       activebackground="red", height=3, font=('Helvetica', 12))
